...
function App() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editId !== null) {
        await axios.put(`http://127.0.0.1:8000/api/todo/${editId}/`, {
          title: title,
          content: content,
        });
        ...
        <div className="todo main  min-h-screen  mx-auto rounded-2xl  mt-3">
          <div className="flex flex-col justify-center items-center gap-4 pt-7">
            <input
              ...
              className=" text-md font-semibold  border border-gray-300 rounded-md py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500 w-120 outline-none"
            />
            <input
              value={content}
            ...
            <button
              ...
              className="w-96 bg-blue-500 hover:bg-blue-700 text-gray-200 font-bold py-2 px-4 rounded cursor-pointer"
            >
            ...
            {editId && (
              <button
                ...
                className="w-96 bg-gray-600 hover:bg-gray-700 text-gray-200 font-bold py-2 px-4 rounded cursor-pointer"
              >
                Cancel
              </button>
            )}
